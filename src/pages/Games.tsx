...
const Games = () => {
  return (
    <div className="min-h-screen bg-background">
      <SeoHead
        title="Featured Games - Board Game Manufacturing Portfolio"
        description="Discover board games manufactured by Oakheart. From strategy games to family favorites, see how we've helped publishers bring their tabletop visions to life with premium components."
        keywords="board game manufacturing, tabletop game production, game publisher portfolio, custom board games, strategy games, family games, card games"
        canonicalUrl="/games"
