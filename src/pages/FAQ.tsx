...
const FAQ = () => {
  return (
    <div className="min-h-screen bg-background">
      <SeoHead
        title="FAQ - Board Game Manufacturing Questions Answered"
        description="Get answers to frequently asked questions about board game manufacturing, pricing, production timelines, custom components, shipping, and Kickstarter fulfillment services."
        keywords="board game manufacturing FAQ, game production questions, MOQ board games, Kickstarter fulfillment, custom game components, board game shipping"
        canonicalUrl="/faq"
        schema={faqSchema}
      />
      <Header />
