...
const Components = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SeoHead
        title="Game Components - Custom Cards, Dice, Miniatures & More"
        description="Explore Oakheart's extensive catalog of premium board game components. Custom playing cards, dice, wooden meeples, plastic miniatures, game boxes, and accessories for tabletop games."
        keywords="board game components, custom playing cards, game dice, wooden meeples, plastic miniatures, game boxes, tabletop game accessories, custom game pieces"
        canonicalUrl="/components"
        ogImage="/factory_photos/08_plastic_figures.jpg"
      />
      <Header />
