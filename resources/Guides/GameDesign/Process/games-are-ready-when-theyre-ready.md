...
After Gencon in 2019, I started working on a spiritual Sci-Fi successor to Maximum Apocalypse. We’ve playtested this baby dozens of times already and it’s going into Art Production. I don’t expect it to make it to Kickstarter until late 2021 at the earliest. It’ll be epic though so worth the wait.
...
We started playtesting the new survivors from the next Maximum Apocalypse with the public at PAX East (March 2019). Art production has been a bit slower this time around and we’re hoping it makes it to Kickstarter next year.
