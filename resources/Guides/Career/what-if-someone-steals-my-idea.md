...
Yes, someone might see the theme of, say, an alternate history of the Civil War, and use that in their game... but then they implement it in a very different way. People think differently, even when thinking on the same thing. Look at any contest or Facebook thread where someone asks what ideas people have around a given mechanic or theme.
...
A lot of these fears and questions come from folks familiar with horror stories in other creative industries (which may also be apocryphal, anecdotal, or exaggerated). These answers can come across as innocent, even naïve.
...
*Should I get them to sign an NDA?* Non-Disclosure Agreements are common in some industries. They're not common in the world of board games, though they are used by some publishers that are generally following corporate strictures. You don't need one as a designer, shouldn't sign an NDA from another designer, and shouldn't ask other designers to sign one. Even if you had someone sign an NDA, there's the matter of enforcement, judgment, and all the time spent doing that... and for what?

The biggest thing to remember here is that feedback can come from anywhere, anyone, and at any time. By limiting the sources it can come from, you limit the opportunities to hear it.
...
Fifth: You will learn far more by sharing your idea than by keeping it secret. I understand that this is a difficult step to take, but just try it once.
...
Do the work. Transform your idea from a couple pages of a notebook to a playtestable game. Get from there to a pitchable game, and ultimately to a publishable game. Execution matters. You need not share every last little piece of information to the world in the process, but you never know where good ideas might come from. Use every opportunity to playtest publicly. It's a mindset change for some, but it's one worth making.

Entro Games is a reader-supported publication. To receive new posts and support my work, consider becoming a free or paid subscriber.
